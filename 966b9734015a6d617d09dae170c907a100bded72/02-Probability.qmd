...
\end{align*}
In the following we focus only on continuous random vectors, but the discrete cases are treated analogously. Properties of **multivariate density** functions: 
...
* [Exercises for Chapter 2](https://www.dropbox.com/scl/fi/bwzvfq2uq5ku2kjiawzs2/Ch2_Exercises1.pdf?rlkey=wuxzuwswiksptlxjnbcunrfv5&dl=0)

<!-- * [Exercises for Chapter 2 with Solultions](https://www.dropbox.com/scl/fi/7f6thor66vukl9thk1crd/Ch2_Exercises_with_Solutions1.pdf?rlkey=3b9p0hxtthv2aiqxl5nm16pid&dl=0) -->
