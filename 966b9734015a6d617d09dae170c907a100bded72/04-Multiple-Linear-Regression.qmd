...
The famous **Gauss-Markov Theorem** states that the OLS estimator is the **"best"** (lowest conditional variance) estimator within the family of linear (in $Y$) and unbiased estimators.
