...
**Showing linearity:** A function $f(Y)$ is called linear in $Y\in\mathbb{R}^n$ if for any two vectors $Y_1\in\mathbb{R}^n$ and $Y_2\in\mathbb{R}^n$ such that $Y=Y_1+Y_2$ and for any scalar $a\in\mathbb{R}$ 
\begin{align*}
...
* [Exercises for Chapter 3](https://www.dropbox.com/scl/fi/305i40sw8s70hq5ekda9x/Ch4_Exercises1.pdf?rlkey=grtj6p813w8vib1m9e55od50f&dl=0)

* [Exercises of Chapter 3 with Solutions](https://www.dropbox.com/scl/fi/4097sc7gy9y8meakn1yoq/Ch4_Exercises_with_Solutions1.pdf?rlkey=4iadb0nk7hqbgag2ge87ifef9&dl=0)
