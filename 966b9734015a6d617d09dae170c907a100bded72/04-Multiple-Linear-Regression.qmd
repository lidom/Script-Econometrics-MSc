...
::: {.callout-note}
Together with the random sample assumption (Assumption 1, Part (b)) @eq-assExogen implies even **strict** exogeneity $E(\varepsilon_i|X) = 0$ since we have independence across $i=1,\dots,n$.  Under strict exogeneity, the mean of $\varepsilon_i$ is zero irrespective of the realizations of $X_1,\dots,X_n$. 
:::
