...
In @sec-ExampleSampleMean, we have derived the exact theoretical distribution of $\bar{X}_n$ under the assumed sampling distribution $(F_X=\mathcal{N}(\mu,\sigma^2));$ namely,
$$
\bar{X}_n\sim\mathcal{N}\left(\mu,\frac{1}{n}\sigma^2\right).
$$ 
