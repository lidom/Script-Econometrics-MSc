...
& = \left(\frac{1}{n}\sum_{i=1}^n X_iX_i^{\top}\right)^{-1} \frac{1}{n}\sum_{i=1}^n X_iY_i  \\
& = \underbrace{\left(\sum_{i=1}^n X_iX_i^{\top}\right)^{-1}}_{\approx (E(X_iX_i^{\top}))^{-1}} \; \underbrace{\sum_{i=1}^n X_iY_i}_{\approx E(X_iY_i)} 
\end{align*}
$$
...
* [Exercises for Chapter 5](https://www.dropbox.com/scl/fi/t6l36vku6aiii3o518voi/Ch5_Exercises1.pdf?rlkey=jgg4e5l5uld4cfakkyy5cztk1&dl=0)


* [Exercises of Chapter 5 with Solutions](https://www.dropbox.com/scl/fi/2arzabv6ydiap8tyh0c4p/Ch5_Exercises_with_Solutions1.pdf?rlkey=dqz2lewoqjxwkqxhvq7jxxf5l&dl=0) 
-->
