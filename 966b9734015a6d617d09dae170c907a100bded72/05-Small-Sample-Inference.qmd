...
* $-c_{1-\alpha}$ (when $H_1:\beta_k< r$) or 
* $\phantom{-}c_{1-\alpha}$ (when $H_1:\beta_k> r$), 
...
&=\underbrace{\frac{\hat\beta_k-3}{\sqrt{\sigma^2[(X'X)^{-1}]_{kk}}}}_{\sim \mathcal{N}(0,1)}+\underbrace{\frac{3-0}{\sqrt{\sigma^2[(X'X)^{-1}]_{kk}}}}_{=\Delta\text{ (mean-shift)}}\overset{H_1}{\sim}\mathcal{N}(\Delta,1)
\end{align*}
