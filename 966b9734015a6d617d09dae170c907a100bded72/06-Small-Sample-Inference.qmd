...
\Leftrightarrow\quad \left(RVar(\hat\beta_n|X)R'\right)^{-1/2}(R\hat\beta_n-r^{(0)})|X&\sim\mathcal{N}_q\left(R\beta -r^{(0)},I_q\right)
\end{align*}
$$ 
...
\Leftrightarrow\quad \left(RVar(\hat\beta_n|X)R'\right)^{-1/2}(R\hat\beta_n-r^{(0)})|X&\overset{{\color{red}{H_0}}}{\sim}\mathcal{N}_q\left(\,{\color{red}0}\,,I_q\right)
\end{align*}
$$ 
...
For the right-sided, one-sided hypothesis
$$
\begin{align*}
...
For the left-sided, one-sided hypothesis
$$
\begin{align*}
