...
$$
W\overset{H_0}{\sim} \chi^2(q).
$$
Note that the distribution of $W$ conditional on $X$ does not depend on $X$; i.e. $W|X\overset{H_0}{\sim}\chi^2(q)$, but $\chi^2(q)$ does not depend on $X$, thus we can write $W\overset{H_0}{\sim} \chi^2(q).$
