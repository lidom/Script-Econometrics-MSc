...
\hat\beta=(X'X)^{-1}X'Y
$$
is a linear (in $Y$) estimator and is unbiased, i.e.
$$
...
$$
So, we can summarize that the OLS estimator belongs to the large family of linear (in $Y$) and unbiased estimators of $\beta.$ The famous Gauss-Markov Theorem states that the OLS estimator is the best (lowest variance) estimator within this family of linear (in $Y$) and unbiased estimators.
